...
beforeEach(async () => {
  ...
  const tables = ['InventoryMovements', 'InventoryItems', 'InventoryGroups', 'MealIngredients', 'Meals', 'Ingredients', 'ConfirmedMenus', 'ShelfChecks', 'WeeklyPlans', 'Children', 'AttendanceCorrections', 'Attendances', 'Activities', 'ScheduleEntries', 'StaffMembers', 'Rooms', 'AuditEvents', 'Sessions', 'LoginAttempts', 'Accounts'];
