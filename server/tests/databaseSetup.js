...
beforeEach(async () => {
  ...
  const tables = ['MealIngredients', 'Meals', 'Ingredients', 'ConfirmedMenus', 'ShelfChecks', 'WeeklyPlans', 'Children', 'AttendanceCorrections', 'Attendances', 'Activities', 'ScheduleEntries', 'Rooms', 'AuditEvents', 'Sessions', 'LoginAttempts', 'Accounts'];
